...
function InputAddressDialog({ onClose, onSubmit }: InputAddressDialogProps) {
	...
	return (
		<section className='flex w-[50vw] flex-col gap-2 rounded-lg border border-slate-500 bg-slate-950 p-2'>
			...
			<input className='bg-bl border border-slate-500 bg-slate-950 p-2 outline-none' type='text' title='address' onChange={(event) => setContent(event.target.value)} />
