...
export function MessageBox({ children, onSubmit, onClose }: MessageBoxProps) {
  ...
  return (
    <section className="flex h-[20vh] w-[80vw] flex-col gap-2 rounded-lg border border-slate-500 bg-slate-950 p-2 md:h-[50vh] md:w-[50vw]">
      ...
      <textarea
        className="h-full w-full resize-none rounded-lg border border-slate-500 bg-transparent p-1 outline-none"
        title="reason"
